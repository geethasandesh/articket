...
function Client() {
  ...
  const categories = [
    { value: 'Inbound Delivery', icon: '📦', description: 'Problems with inbound delivery processing' },
    { value: 'Outbound Delivery', icon: '🚚', description: 'Issues with outbound delivery/shipping' },
    { value: 'Stock Management', icon: '🏷️', description: 'Stock discrepancies or inventory errors' },
    { value: 'Warehouse Task', icon: '📝', description: 'Warehouse task creation or confirmation issues' },
    { value: 'RFUI', icon: '📱', description: 'Radio Frequency UI (RFUI) problems' },
    { value: 'Resource Management', icon: '👷', description: 'Resource assignment or labor management' },
    { value: 'Physical Inventory', icon: '🧾', description: 'Physical inventory or counting issues' },
    { value: 'Others', icon: '➕', description: 'Other SAP EWM issues' }
  ];
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        {categories.map(category => (
                          <button
                            key={category.value}
                            type="button"
                            onClick={() => setFormData(prev => ({ ...prev, category: category.value, otherIssue: '' }))}
                            className={`p-4 rounded-xl border-2 transition-all duration-200 text-left shadow-sm flex items-center gap-3 ${
                          ...
                          >
                            ...
                            <div>
                              <div className="font-medium text-sm">{category.value}</div>
                        ...
                        {priorities.map(priority => (
                          ...
                          >
                            <div className="flex items-center space-x-2">
                              ...
                              <span className="font-semibold text-lg">{priority.value}</span>
                            </div>
